...
#import "WorkshopTableViewController.h"
#import "WorkShopDetailViewController.h"

@interface WorkshopTableViewController ()

@end

@implementation WorkshopTableViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"showWork"]) {
        ...
        WorkShopDetailViewController *transferObject = (WorkShopDetailViewController *)segue.destinationViewController;
